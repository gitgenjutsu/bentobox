  ...
  return (
    <header className="bg-white shadow-md sticky top-0 z-50">
      <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
        <h1 className="text-2xl font-bold text-emerald-600">🍱 BentoBox</h1>
      ...
      {isMenuOpen && (
        <div className="md:hidden px-6 pb-4 flex flex-col gap-4 bg-white border-t">
          <NavLink to="/" className={navLinkClass} onClick={() => setIsMenuOpen(!isMenuOpen)}>
            {t("home")}
          </NavLink>
          <NavLink to="/menu" className={navLinkClass} onClick={() => setIsMenuOpen(!isMenuOpen)}>
            {t("menu")}
          </NavLink>
          <NavLink to="/checkout" className={navLinkClass} onClick={() => setIsMenuOpen(!isMenuOpen)}>
            {t("checkout")}
          </NavLink>
